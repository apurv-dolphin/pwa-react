...
import defaultClasses from '@magento/venia-ui/lib/RootComponents/Category/NoProductsFound/noProductsFound.module.css';
    ...
    return (
        <div className={classes.root} data-cy="NoProductsFound-root">
            <Image
                ...
                src="https://harinafoods.com/assets/images/product_not_found2.png"
            />
            ...
            <div className={classes.categories}>
                ...
                <ul className={classes.list} style={{ color: '#0e20ff' }}>
                    {categoryItems}
                </ul>
            </div>
        </div>
